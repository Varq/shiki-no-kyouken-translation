...
function Serihu()
{
   ...
   if(_root.mojiSerihu == 18)
   {
      ...
      _root.tKaoBBan = 2;
      _root.tKaoBHenkou();
      _root.PS01t_str = "ああ、今日も片付けが";
      _root.PS02t_str = "長引いてしまうとは…";
      _root.PS03t_str = "";
   }
   if(_root.mojiSerihu == 19)
   {
      ...
      _root.oKaoBBan = 6;
      _root.oKaoBHenkou();
      _root.PS01_str = "用心棒さんも";
      _root.PS02_str = "店の片付けになると";
      _root.PS03_str = "力を発揮できないものね～";
   }
   if(_root.mojiSerihu == 20)
   {
      ...
      _root.tKaoBBan = 40;
      _root.tKaoBHenkou();
      _root.PS01t_str = "でもいいじゃないか";
      _root.PS02t_str = "皆で入るのも";
      _root.PS03t_str = "楽しい事じゃない";
   }
   ...
   if(_root.mojiSerihu == 23)
   {
      ...
      _root.oKaoBBan = 2;
      _root.oKaoBHenkou();
      _root.PS01_str = "いや、私はそういう心配でなくてだ";
      _root.PS02_str = "二人がいるとまたあいつが";
      _root.PS03_str = "覗きに来る可能性をだな";
   }
   if(_root.mojiSerihu == 24)
   {
      ...
      _root.tKaoBBan = 6;
      _root.tKaoBHenkou();
      _root.PS01t_str = "う～ん、絶阿の疑いは";
      _root.PS02t_str = "一応は晴れたんだけどね";
      _root.PS03t_str = "";
   }
   if(_root.mojiSerihu == 25)
   {
      ...
      _root.oKaoBBan = 40;
      _root.oKaoBHenkou();
      _root.PS01_str = "あの吾己は";
      _root.PS02_str = "ほら吹いてる時の吾己だったよ";
      _root.PS03_str = "";
   }
   if(_root.mojiSerihu == 26)
   {
      ...
      _root.tKaoBBan = 2;
      _root.tKaoBHenkou();
      _root.PS01t_str = "やはりあいつは";
      _root.PS02t_str = "覗いていたに違いない…";
      _root.PS03t_str = "今度問い詰めてやる";
   }
   if(_root.mojiSerihu == 27)
   {
      ...
      _root.oKaoBBan = 6;
      _root.oKaoBHenkou();
      _root.PS01_str = "まぁまぁ、絶阿も";
      _root.PS02_str = "お年頃なのよ～";
      _root.PS03_str = "その辺はわかってあげなくちゃ";
   }
   if(_root.mojiSerihu == 28)
   {
      ...
      _root.PS02t_str = "覗きは犯罪だと体に叩き込まないと";
      _root.PS03t_str = "いけない事はいけないね";
   }
   if(_root.mojiSerihu == 29)
   {
      ...
      _root.oKaoBHenkou();
      _root.PS01_str = "そうだな";
      _root.PS02_str = "蝋燭でも尻の穴に";
      _root.PS03_str = "突き刺してやろうかな";
   }
   if(_root.mojiSerihu == 30)
   {
      ...
      _root.tKaoBBan = 1;
      _root.tKaoBHenkou();
      _root.PS01t_str = "あついあついあつい！！！";
      _root.PS02t_str = "いたいいたいいたい！！！！";
      _root.PS03t_str = "";
   }
   ...
   if(_root.mojiSerihu == 32)
   {
      ...
      _root.PS02t_str = "実際にやられた所を想像して";
      _root.PS03t_str = "正確に熱さを感じ取ってしまった！";
   }
   ...
   if(_root.mojiSerihu == 34)
   {
      ...
      _root.tManpuH = 2;
      _root.tKaoBan = 18;
      _root.PS01t_str = "なんという驚異的想像力…";
      _root.PS02t_str = "この想像力を活用させて";
      _root.PS03t_str = "とりあえず逃げるぜ！！";
   }
   ...
   if(_root.mojiSerihu == 40)
   {
      ...
      _root.tKaoBBan = 21;
      _root.tKaoBHenkou();
      _root.PS01t_str = "あらあら、町を歩きたくない";
      _root.PS02t_str = "理由でもおありですか？";
      _root.PS03t_str = "";
   }
   ...
   if(_root.mojiSerihu == 42)
   {
      ...
      _root.tManpuH = 6;
      _root.tKaoBan = 31;
      _root.PS01t_str = "ようやく見つけました～";
      _root.PS02t_str = "変態覗き妖怪さん";
      _root.PS03t_str = "";
   }
   ...
   if(_root.mojiSerihu == 44)
   {
      ...
      _root.tManpuH = 0;
      _root.tKaoBan = 18;
      _root.PS01t_str = "今度は少々";
      _root.PS02t_str = "抑え目にしてあげますから";
      _root.PS03t_str = "おとなしくしてください";
   }
