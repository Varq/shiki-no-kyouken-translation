...
function Serihu()
{
   ...
   if(_root.mojiSerihu == 1)
   {
      ...
      _root.tKaoBBan = 22;
      _root.tKaoBHenkou();
      _root.PS01t_str = "あれれ・・・・なんで・・・・";
      _root.PS02t_str = "おかしいな・・・・";
      _root.PS03t_str = "勝てるはずなのに・・・・";
   }
   ...
   if(_root.mojiSerihu == 3)
   {
      ...
      _root.tManpuH = 8;
      _root.tKaoBan = 49;
      _root.PS01t_str = "お姉ちゃん…また一緒だね…";
      _root.PS02t_str = "天国でも…がんば…ろう";
      _root.PS03t_str = "…ね…";
   }
   ...
   if(_root.mojiSerihu == 33)
   {
      ...
      _root.oManpuH = 12;
      _root.oKaoBan = 14;
      _root.PS01_str = "みたいだな…";
      _root.PS02_str = "身内を殺したやつだってのにな…";
      _root.PS03_str = "";
   }
   if(_root.mojiSerihu == 34)
   {
      ...
      _root.tManpuH = 0;
      _root.tKaoBan = 6;
      _root.PS01t_str = "こちらから挑んだ真剣勝負に";
      _root.PS02t_str = "あなたが勝利しただけ…";
      _root.PS03t_str = "香奈伊ちゃんもわかっていますよ";
   }
   ...
   if(_root.mojiSerihu == 60)
   {
      ...
      _root.oManpuH = 10;
      _root.oKaoBan = 12;
      _root.PS01_str = "な、なぜ衣装に動物の";
      _root.PS02_str = "耳と尻尾が付いているの？";
      _root.PS03_str = "";
   }
   ...
   if(_root.mojiSerihu == 62)
   {
      ...
      _root.tManpuH = 7;
      _root.tKaoBan = 13;
      _root.PS01t_str = "お茶を運んでは撫でてもらい";
      _root.PS02t_str = "うにゃんうにゃんと鳴き潤む";
      _root.PS03t_str = "こりゃあ癒しの最先端だぜ！！";
   }
   ...
   if(_root.mojiSerihu == 65)
   {
      ...
      _root.tManpuH = 6;
      _root.tKaoBan = 5;
      _root.PS01t_str = "動物茶屋園屋で";
      _root.PS02t_str = "等身大の動物達と触れ合って";
      _root.PS03t_str = "あなたもごろにゃーーんだ！！";
   }
   ...
   if(_root.mojiSerihu == 68)
   {
      ...
      _root.oKaoBBan = 1;
      _root.oKaoBHenkou();
      _root.PS01_str = "無理無理！！うお！吊るすなって";
      _root.PS02_str = "っておわああ！重力無視してる！";
      _root.PS03_str = "上ってくる上って…ああああ！！！";
   }
